...
import 'package:epguides_notifier_app/app/data/services/notification_service_impl.dart';
...
class AppModule extends Module {
  final FlutterNotificationDriver? driver;
  ...
  List<Bind> get binds => [
        ...
        Bind((i) => AddSitcomWatchListUsecaseImpl(
            ...
            notificationService: NotificationServiceImpl(i()))),
        Bind((i) => SitcomBloc(
            getSitcomsUsecase: i(),
